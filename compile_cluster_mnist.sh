...
FILENAME='code/inference/variational/mteugp/experiments/mnist/mteugpTestMNIST.m'
P1='./data'
P2='./code/inference/variational/mteugp'
P3='./code/inference/variational/utils'
P4='./code/inference/features'
P5='./external'
TARGETDIR='standalone/MNIST'
...
/share/apps/matlab/2014b/bin/mcc -R -nojvm -m  $FILENAME -a $P1 -a $P2 -a $P3 -a $P4 -a $P5 -d $TARGETDIR -o mteugpMNIST -v 
