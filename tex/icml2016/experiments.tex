...
forward model in this task \todo{and the same settings as in the original
...
Unlike the last experiment, the \eks and \uks do not perform as well as the
...
basis functions \todo{does this jibe with you Edwin?}. The performance of the
